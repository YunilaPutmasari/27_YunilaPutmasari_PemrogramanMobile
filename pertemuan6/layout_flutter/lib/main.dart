...
class MyApp extends StatelessWidget {
      ...
      child: Row(
        children: [
          Expanded(
            ...
            child: Column(
              crossAxisAlignment:
                  CrossAxisAlignment.start, // Memposisikan kolom di awal baris
              children: [
                /* soal 2*/
                Container(
                  padding: const EdgeInsets.only(
                      bottom: 8), // Padding bawah untuk teks judul
                  child: const Text(
  ...
  child: const Text(
    ...
    return MaterialApp(
      title: 'Flutter Layout: Yunila Putmasari 2241720062',
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Flutter Layout Demo'),
        ),
        body: ListView( //ListView mendukung scroll yang dinamis saat aplikasi dijalankan pada perangkat yang resolusinya lebih kecil.
          children: [
            Image.asset( 'images/bromo.jpeg', 
            width : 600,
            height: 240,
            fit : BoxFit.cover,),
